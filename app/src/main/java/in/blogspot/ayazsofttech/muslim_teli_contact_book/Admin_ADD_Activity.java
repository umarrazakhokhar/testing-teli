...
public class Admin_ADD_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView heading=findViewById(R.id.heading);//we use activity_edit_pofile.xml
        heading.setText("Admin Edit");
        ...
        if ( !AppStatus.getInstance(Admin_ADD_Activity.this).isOnline()) {
            new AlertDialog.Builder(Admin_ADD_Activity.this,R.style.MyDialogTheme)
        ...
        //Spiner for spinner_district
       // Spinner_District(District.getText().toString());

        //Spiner state
        //Spinner_State(State.getText().toString());
                            ...
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface arg0, int arg1) {
                                    ...
                                    if(result == true)
                                    {
                                        ...
                                        Toast.makeText(Admin_ADD_Activity.this,"Successfully Added SQLite",Toast.LENGTH_LONG).show();
                                        finish();

                                    }
                                    else
                                    { Toast.makeText(Admin_ADD_Activity.this,"Not ADD", Toast.LENGTH_LONG).show(); }
    ...
    private void alertMessageBox() {
        new AlertDialog.Builder(Admin_ADD_Activity.this)
